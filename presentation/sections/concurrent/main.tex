\begin{frame}
	...
	\begin{itemize}
		...
		\item<1-> Describing signature exchange between A(lice) and B(ob)
		\item<2-> Initial signer has to generate keystone
		\item<3-> Matching signer responds by using the same keystone-fix
		\item<4-> both parties \textit{ambiguous} until $k$ released
	\end{itemize}
\end{frame}
